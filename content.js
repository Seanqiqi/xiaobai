...
const CHARACTERS = [
  {
    ...
    keywords: [
      ...
      '悦', '月', '越', '乐', '岳', '粤', '阅', '曰', '约', '跃',
      '导览', '向导', '讲解',
      '主页', '首页', '返回', '菜单', '回家', '主页面', '开始',
      // 注：白云街道/白云山/景星寺/谛闲/星星广场/白云飞瀑/岩屿公园 等 3+ 字长词
      //     已移到知识库，避免与"白云街道+限定词"的问答（如Q9智造角色）误匹配
      '美食', '小吃', '烟火气'
    ],
    greeting: '嗨~大家好呀！我是来自浙江省台州市椒江区白云街道的可爱数字人"悦白"。',
    sections: [
    ...
    prompt: '你想了解哪个主题呢？喊出小伙伴的名字就可以请出他们了！'
  },

  {
    ...
    keywords: [
      ...
      '韵', '运', '云', '允', '晕', '孕', '匀', '耘', '熨', '蕴',
      // 主题关键词：3+字的长概念（民俗艺术/吴子雄/艺术馆/博物馆/邻里守望/云享驿站/文艺轻骑兵）
      //   已移到知识库做 AND 匹配，避免单个词拦截带限定词的问答（如Q7"云健+邻里守望"会被邻里守望拦截）
      '传统', '文艺', '非遗', '艺术', '文化', '民俗', '文物',
      '玻璃', '刺绣', '台绣', '越剧', '舞蹈', '戏曲',
      '云健', '皮影戏', '剪纸', '民歌', '云邻'
    ],
    greeting: '我在，我是白小韵！欢迎来到白云街道的文化世界！',
    sections: [
      '街道因白云山得名，辖区内有市民广场、云西公园、和合公园、腾达中心等多处城市景观',
      '如果你想去白云街道走一走的话，一定要去云中绿道溜一圈，那里除了白云阁还有深受年轻人喜爱的反卷公社。',
      '还有场馆一条街也是个好去处，青少年活动中心、妇女儿童活动中心、博物馆、科技馆、数字馆都是热门打卡地。',
      '要是周末懒得跑远，文艺轻骑兵还把越剧、舞蹈搬到你家楼下，坐个电梯的功夫就能听上一段好戏',
      '，还可以去市民广场的新型阅读空间云享驿站看书喝茶，去吴子雄玻璃艺术馆、台绣博物馆领略非遗魅力。',
      '在咱们白云，文化正走进街头巷尾、融进一日三餐的烟火气里，尤其是邻里守望的文化金名片，习总书记都点赞过呢。'
    ],
    prompt: '白云的文化生活是不是很有意思？你还想了解其他的吗？'
  },

  {
    ...
    keywords: [
      ...
      '智', '指', '治', '志', '置', '致', '稚', '质', '知', '织',
      // 主题关键词：3+字的长概念（3D打印/数字化/机器人）
      //   已移到知识库做 AND 匹配。
      //   注意："智造""制造""科创""科技""技术""工业""工厂""马桶""缝纫机""汽车""吉利""杰克""企业""阳光码""朝夕相伴"
      //   等 2-3 字词保留，因为它们是通用触发，不会误拦截更具体的问答。
      '智能', '制造', '科创', '机器人', '科技', '智造', '技术', '工业', '工厂',
      '马桶', '缝纫机', '汽车', '吉利', '杰克', '数字化', '企业',
      '阳光码', '朝夕相伴'
    ],
    greeting: '我在，我是白小智！带大家了解一下台州是怎样从“制造”升级成“智造”。',
    sections: [
      '你相信吗？台州人天生自带"变废为宝"的超能力————',
      '几十年前从小五金敲敲打打起家，硬是敲出了黄岩模具、路桥汽摩配、玉环阀门这些"一镇一业"的大阵仗！',
      '如今更厉害了，工厂里全是智能设备唱主角。',
      '给你爆个冷知识：全国每10台智能马桶，6台是台州造，椒江还是"主力军"哦。',
      '你家的智能马桶，说不定就是邻居家的工厂生产的！',
    ],
...

  {
    ...
    keywords: [
      ...
      '根', '跟', '哏', '更', '庚', '羹', '梗',
      '坎', '砍', '侃',
      // 主题关键词：3+字的长概念（垦荒精神/大陈岛/实践营/追光少年/海岛行/两山行/智造行/艰苦创业/奋发图强）
      //   已移到知识库做 AND 匹配，避免单个长词拦截"实践营+具体问题"式的提问
      '垦荒', '大陈', '奋斗', '开拓', '精神', '红色'
    ],
    greeting: '我在，我是白小垦！今天我要给大家讲一个关于勇敢和奋斗的故事。',
    sections: [
      '很久以前，在浙江台州，有一座美丽的海岛叫做大陈岛。1955年1月，英勇的人民解放军首次陆海空三军协同登陆作战',
      '把最后驻守在岛上的国民党军队赶出了大陆，浙江沿海全面解放，但是大陈岛也变成了一座荒岛。',
      '一年后，一群青年志愿者响应号召来到大陈岛。他们不怕苦不怕累，开荒种地、修路建房，用双手把荒岛变成了绿洲，',
      '也孕育出“艰苦创业 奋发图强 无私奉献 开拓创新”的大陈岛垦荒精神。',
      '70年来，垦荒精神在台州薪火相传，升华为城市精神，融入台州人的血脉，成为台州高质量发展的精神动力。'
    ],
    prompt: '故事结束，你还有什么想了解的吗？'
  },

  {
    ...
    keywords: [
      ...
      // 主题关键词：3+字的长概念（数字文明/数字孪生/未来世界/智能管家/十年以后/低空经济/移动健康舱/人工智能）
      //   已移到知识库做 AND 匹配，避免单个长词拦截带限定词的问答（如"阳光码+治理"Q11会被阳光码拦截切角色）
      '未来', '孪生', '虚拟', '科幻',
      '阳光码', 'AI', '全息', '智慧',
      '无人机', '健康'
    ],
    greeting: '我在，我是白小未！跟我一起穿越到未来的数字世界吧！',
    sections: [
      '未来的白云应该是一个智慧、温暖又充满活力的家园！产业持续创新发展，文化气息四处流淌，科技融入生活的方方面面。',
      '可能在若干年后，家家都有个全能管家，想啥来啥——',
      '早上睁眼窗帘自动开，厨房按你的健康需求配好早餐；出门无人小巴楼下等你，回家快递已经帮你签收；想爸妈？全息投影一秒"面对面"！',
...
const KNOWLEDGE_BASE = [
  ...
  // Q2: 大陈岛垦荒精神实践营到底是什么呀？
  {
    ...
    answer: [
      ...
      '实践营大本营在云海社区哦！只要你是白云街道的少年儿童，都能报名参加！',
  ...
  {
    keywords: [
      ['习近平', '垦荒精神', '什么'], ['什么是', '垦荒'], ['垦荒精神', '解释'],['20年前','垦荒精神','故事'],
  ...
  // Q6: 追光少年”是我们街道垦荒实践营第四个垦荒少年系列，从去年寒假的“海岛行”，到暑假的“两山行”，再到今年暑期的“智造行”，实践营的每一次主题变化说明了什么？
  {
    keywords: [
      ...
      ['追光少年', '实践营','变化'], ['追光少年', '迭代'],['主题', '变化'],['暑假','寒假'],['实践营', '主题', '变化']
    ],
    answer: [
  ...
  // Q9: 白云街道在台州智造发展中扮演什么样的角色？
  {
    keywords: [
      ...
      ['白云街道', '制造', '角色'], ['白云街道', '制造', '发展'],   // 语音识别容错：智造→制造
      ['白云街道', '智造', '什么'], ['白云街道', '制造', '什么'],   // "扮演什么角色""起什么作用"
      ['角色', '台州智造'], ['角色', '台州制造'],
      ['亿元', '楼宇'], ['街道', '智造', '扮演'], ['街道', '制造', '扮演']
    ],
    answer: [
